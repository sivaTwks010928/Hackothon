  ...
  return (
    <React.Fragment>
      ...
      <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
        Please review your resume information below. Click the edit button to make changes to any section.
      </Typography>
        ...
        {isEmpty(formData.name) && isEmpty(formData.role) && isEmpty(formData.summary) ? (
          ...
          <List dense>
            ...
            {!isEmpty(formData.summary) && (
              <ListItem>
                <ListItemText
                  primary="Professional Summary"
                  secondary={formData.summary}
                />
              </ListItem>
            )}
          </List>
                  ...
                  <Box sx={{ mt: 1 }}>
                    ...
                    <List dense sx={{ pl: 2 }}>
                      {exp.descriptions.map((desc, idx) => (
                        !isEmpty(desc) && (
                          <ListItem key={idx} sx={{ display: 'list-item', listStyleType: 'disc', py: 0 }}>
      ...
      <Box sx={{ mt: 3, p: 2, backgroundColor: '#f9f9f9', borderRadius: 1 }}>
        <Typography variant="body2" color="text.secondary">
          <strong>Ready to generate?</strong> Click the 'Generate Resume' button below when you've reviewed all your information.
          You'll be able to preview your resume before downloading.
        </Typography>
      </Box>
    </React.Fragment>
  );
