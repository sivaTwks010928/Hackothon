...
const ThoughtworksExperienceForm: React.FC<ThoughtworksExperienceFormProps> = ({
  formData,
  setFormData,
}) => {
  ...
  return (
    <React.Fragment>
      ...
      <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
        List your work experience at ThoughtWorks. Include project roles, responsibilities, and
        achievements.
      </Typography>
      ...
      {formData.thoughtworks_experiences.map((exp, expIndex) => (
        <Paper key={expIndex} sx={{ p: 2, mb: 3, backgroundColor: '#f9f9f9' }}>
          ...
          {expIndex < formData.thoughtworks_experiences.length - 1 && <Divider sx={{ my: 3 }} />}
        </Paper>
      ))}
