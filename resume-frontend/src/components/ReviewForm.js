  ...
  return (
    <React.Fragment>
      ...
      <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
        Please review your resume information before generating the PDF. Use the Edit buttons to go
      ...
      <Paper elevation={0} variant="outlined" sx={{ p: 3, mb: 3 }}>
        ...
        >
          ...
          <Button startIcon={<EditIcon />} size="small" onClick={() => navigateToSection(0)}>
            Edit
          </Button>
        </Box>
        <Divider sx={{ mb: 2 }} />
      ...
      <Paper elevation={0} variant="outlined" sx={{ p: 3, mb: 3 }}>
        ...
        >
          ...
          <Button startIcon={<EditIcon />} size="small" onClick={() => navigateToSection(1)}>
            Edit
          </Button>
        </Box>
        <Divider sx={{ mb: 2 }} />
                ...
                <Box key={index} sx={{ mb: 3 }}>
                  ...
                  {!isEmpty(exp.tech_stack) && (
                    <Box sx={{ mt: 1 }}>
                      ...
                      <Typography variant="body2">{exp.tech_stack}</Typography>
                    </Box>
                  )}

                  {index <
                    formData.thoughtworks_experiences.filter(e => !experienceEmpty(e)).length -
                      1 && <Divider sx={{ my: 2 }} />}
                </Box>
              )
          )
      ...
      <Paper elevation={0} variant="outlined" sx={{ p: 3, mb: 3 }}>
        ...
        >
          ...
          <Button startIcon={<EditIcon />} size="small" onClick={() => navigateToSection(2)}>
            Edit
          </Button>
        </Box>
        <Divider sx={{ mb: 2 }} />
            ...
            (exp, index) =>
              !experienceEmpty(exp) && (
                <Box key={index} sx={{ mb: 3 }}>
                  ...
                  {index <
                    formData.other_experiences.filter(e => !experienceEmpty(e)).length - 1 && (
                    <Divider sx={{ my: 2 }} />
                  )}
                </Box>
              )
      ...
      <Paper elevation={0} variant="outlined" sx={{ p: 3, mb: 3 }}>
        ...
        >
          ...
          <Button startIcon={<EditIcon />} size="small" onClick={() => navigateToSection(3)}>
            Edit
          </Button>
        </Box>
        <Divider sx={{ mb: 2 }} />
      ...
      <Box sx={{ mt: 3, p: 2, backgroundColor: '#f9f9f9', borderRadius: 1, mb: 4 }}>
        <Typography variant="body2" color="text.secondary">
          <strong>Tip:</strong> Before generating your resume, make sure all sections are filled out
          with accurate information. You can preview your resume before downloading the final PDF.
        </Typography>
      </Box>
