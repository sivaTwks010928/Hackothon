...
# Import functions from pdf_generation module
from pdf_generation import escape_latex, generate_resume_pdf, sanitize_data
...
sample_data = {
    ...
    "skills": [
        ...
        {"title": "Security Testing Tools", "skills": "OWASP, ZAP"},
        {
            ...
            "skills": "Appium, Mobile Device Management, Cross-Browser Testing",
        },
        {
            "title": "Certifications",
            "skills": "ISTQB Certified Tester, Certified Selenium Professional",
        },
    ],
}
...
def generate_pdf():
    ...
    try:
        ...
        pdf_path = generate_resume_pdf(temp_dir, data)
